...
def run():
	...
	cycle_d = 90
	Qrate = 0
	start_a = [45,45,0,0,68,67,23,22]
	duration_a = [22,23,22,23,22,23,22,23]

	start_b =[45,45,0,0,68,67,23,22]
	duration_b = [22,23,22,23,22,23,22,23]

	start_c =[68,67,0,0,45,45,23,22]
	duration_c = [22,23,22,23,22,23,22,23]	

	start_d =[68,67,23,0,45,45,23,0]
	duration_d = [22,23,22,23,22,23,22,23]		
	"""
	cycle_a = 100
